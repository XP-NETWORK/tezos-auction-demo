...
class NFTWallet(sp.Contract):
    ...
    def configNftAuction(self, params):
        ...
        auction_contract = sp.contract(AUCTION_PARAMS_TYPE, params.auction_address,
                                       entry_point="configureAuction").open_some()
...
def test():
    ...
    token_metadata = sp.map({"name": sp.utils.bytes_of_string("Nft1")})
